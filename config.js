...
function getDatabaseUri() {
  ...
  const hostedDatabaseConnectionString = process.env.DATABASE_HOSTED_CONNECTION_STRING;

  if (hostedDatabaseConnectionString) {
    return hostedDatabaseConnectionString;
  } else {
